...
- (void)fetchCommandsFromJs
{
    ...
    [_viewController.webView evaluateJavaScript:@"cordova.require('cordova/exec').nativeFetchMessages()" completionHandler:^(id _Nullable queuedCommandsJSON, NSError * _Nullable error) {
