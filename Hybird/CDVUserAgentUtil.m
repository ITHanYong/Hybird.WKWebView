...
+ (void)originalUserAgent:(void (^)(NSString *UserAgent))block
{
    if (gOriginalUserAgent == nil) {
        ...
        if ((gOriginalUserAgent == nil) || cachedValueIsOld) {
            ...
            WKWebView* sampleWebView = [[UIWebView alloc] initWithFrame:CGRectZero];
            /*
            ...
            */
            [sampleWebView evaluateJavaScript:@"navigator.userAgent" completionHandler:^(id _Nullable oldAgent, NSError * _Nullable error) {
                ...
                sampleWebView.customUserAgent = newAgent;
                NSDictionary *dictionnary = [[NSDictionary alloc] initWithObjectsAndKeys:newAgent, @"UserAgent", nil];
                [[NSUserDefaults standardUserDefaults] registerDefaults:dictionnary];
                [[NSUserDefaults standardUserDefaults] synchronize];
                
                block(gOriginalUserAgent);
            }];
        }
    }
